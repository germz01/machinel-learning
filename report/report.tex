        ...
        \begin{subtable}{\textwidth}
            \resizebox{\textwidth}{!}{
                \begin{tabular}{| c | c | c | c | c | c | c | c | c |}
                    ...
                    Accuracy (TR - TS) (\%) \\
                    \hline
                    MONK 1 & 17 -> 3 -> 1 & batch & sigmoid & 0.8 & 0.9 & 0.0 & 0.0318 - 0.0487 &
                    97 \% - 94 \% \\
                    \hline
                    MONK 2 & 17 -> 3 -> 1 & batch & sigmoid & 0.5 & 0.9 & 0.0 & 0.0014 - 0.0015 &
                    100 \% - 100 \% \\
                    \hline
                    MONK 3 & 17 -> 3 -> 1 & batch & sigmoid & 0.6 & 0.9 & 0.0 & 0.0228 - 0.0477 &
                    97.8 \% - 93.7 \% \\
                    \hline
                    MONK 3 (reg.) & 17 -> 3 -> 1 & batch & sigmoid & 0.6 & 0.9 & 0.01 & 0.0596 - 0.0482 &
                    93.3 \% - 97.1 \% \\
                    \hline
                \end{tabular}
            }
