...
\item Early Stopping testing.
  ...
  \end{figure}
    ...
    \caption{ Early stopping example. The vertical lines represents the early stopping points computed with $PQ_{1\%}$ and $GL_{1\%}$ methods and the point of minimum MSE validation error.}
